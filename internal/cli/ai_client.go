...
- For lead source creates, use natural words or an explicit path, for example: api create lead source --body '{"name":"Angi"}' --plan --json or api --method POST --path /lead_sources --body '{"name":"Angi"}' --plan --json
